...
<div class="container">
    ...
    <div class="jumbotron text-center">
        ...
        <a class="btn btn-success btn-lg" href="<?= base_url(); ?>/data_kk" role="button">Dashboard Data KK</a>
        <a class="btn btn-primary btn-lg" href="<?= base_url(); ?>/data_idv" role="button">Dashboard Data Penduduk</a>
c
    </div>
